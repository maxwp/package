...
class Storage_HandlerMemcache implements Storage_IHandler {
    ...
    public function set($key, $value, $ttl = false, $parentKey = false) {
        ...
        $this->_link->set($this->_prefix.$key, $value, false, $ttl);
    }
    ...
    public function get($key) {
        ...
        $result = $this->_link->get($this->_prefix.$key);
        if ($result !== false) {
            return $result;
        }

        throw new Storage_Exception("Cache by key not found");
    }
    ...
    public function has($key) {
        ...
        return ($this->_link->get($this->_prefix.$key) != false);
    }
