...
class MailUtils_SenderSMTP implements MailUtils_ISender {
    ...
    public function send(MailUtils_Letter $letter, $startDate = false) {
        if (MailUtils_Config::Get()->isVerboseMode()) {
            print 'Process Sender MailUtils_SenderSMTP send from ' .
                $letter->getEmailFrom() . ' to ' . $letter->getEmailTo()."\n";
        }
        if ($startDate) {
        ...
        if (MailUtils_Config::Get()->isVerboseMode()) {
            print 'Process Sender MailUtils_SenderSMTP send from ' . $letter->getEmailFrom()
                . ' to ' . $letter->getEmailTo() . "OK...\n";
        }
